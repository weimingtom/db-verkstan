...
#define DEF_OP(opName, opClass, opType)             \
    ...
    {                                               \
        ...
        List<Constants::OperatorTypes>^ inConnectionTypes = gcnew List<Constants::OperatorTypes>();\
...
#define ADD_IN(inType) \
    inConnectionTypes->Add(Constants::OperatorTypes::##inType);
#define END_OP() }
