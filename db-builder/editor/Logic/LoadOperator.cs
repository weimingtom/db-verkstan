...
namespace VerkstanEditor.Logic
{
    class LoadOperator: Operator
    {
        ...
        public override ICollection<Verkstan.OperatorBindingProperty> Properties
        {
            get
            {
                ICollection<Verkstan.OperatorBindingProperty> properties = new List<Verkstan.OperatorBindingProperty>();
                properties.Add(new Verkstan.OperatorBindingProperty(0, "Target", Verkstan.Constants.OperatorPropertyTypes.String));
                return properties;
            }
        }
