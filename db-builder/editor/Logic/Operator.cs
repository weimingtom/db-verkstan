...
namespace VerkstanEditor.Logic
{
    public abstract class Operator : IDisposable
    {
        ...
        public abstract ICollection<Verkstan.OperatorBindingProperty> Properties { get; }
        public abstract String TypeName  { get; }
        public abstract bool IsProcessable { get; }
        public abstract Verkstan.Constants.OperatorTypes Type { get; }
        public abstract Verkstan.OperatorBinding BindedOperator { get; }
        #endregion
        ...
        {
            return BindedOperator.GetByteProperty(index);
        }
        public void SetByteProperty(int index, byte value)
        {
            BindedOperator.SetByteProperty(index, value);
        }
        public int GetIntProperty(int index)
        {
            return BindedOperator.GetIntProperty(index);
        }
        public void SetIntProperty(int index, int value)
        {
            BindedOperator.SetIntProperty(index, value);
        }
        public float GetFloatProperty(int index)
        {
            return BindedOperator.GetFloatProperty(index);
        }
        public void SetFloatProperty(int index, float value)
        {
            BindedOperator.SetFloatProperty(index, value);
        }
        public Color GetColorProperty(int index)
        {
            Verkstan.Color vc = BindedOperator.GetColorProperty(index);
